                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="badge badge-inline badge-success">{{translate('Paid')}} - 
                            @else
                            <span class="badge badge-inline badge-danger">{{translate('Unpaid')}} - 
                            @endif
                        ...
                        <td class="text-right">
                            <select class="actionku w-100" name="optioncek" id="optioncek">
                                ...
                                @endphp
                                <option value="{{ $order_detail_route }}">
                                    <i class="las la-eye"></i> Lihat Detail
                                </option>
                            @endcan
                            <option value="{{ route('invoice.download', $order->id) }}">
                                <i class="las la-download"></i> Download Data
                            </option>
                            @can('delete_order')
                                <option value="del-{{route('orders.destroy', $order->id)}}">
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).on("change", "#optioncek", function(e) {
            if(this.value.includes("del-") == true){
                e.preventDefault();
                var url = this.value.replace("del-","");
