    ...
    <div class="modal-body gry-bg px-3 pt-3 mx-auto">
        ...
        <div id="manual_payment_data">
            ...
            <div class="card mb-3 p-3">
                 <input type="hidden"class="hide" min="0" step="0.01" value="{{($nominal)}}" name="amount" >
                <div class="row mt-3">
                    <div class="col-md-3">
                        <label>Nominal<span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-9">
                        <input type="text" disabled="true" class="form-control mb-3" value="{{single_price($nominal)}}" >
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <label>Nomor Rekening Pelanggan <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-9">
                        <input type="text" class="form-control mb-3" name="trx_id" placeholder="{{ translate('Nomor Rekening Mu') }}" required>
                    </div>
                </div>
  ...
  <div id="manual_payment_info_{{ $method->id }}" class="d-none">
      ...
      @if ($method->bank_info != null)
          <ul>
              ...
              @endforeach
                <li>Nominal Pembayaran harus sesuai dengan nominal yang seharusnya dibayarkan atau Pesanan Tidak Diproses</li>
          </ul>
      @endif
  </div>
@endforeach
