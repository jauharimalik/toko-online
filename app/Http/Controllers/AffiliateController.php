...
//        dd($type);
    ...
    public function payment_settings_store(Request $request){
        ...
        $affiliate_user->nama_rekening = $request->nama_rekening;
        $affiliate_user->nomor_rekening = $request->nomor_rekening;
        $affiliate_user->kode_bank = $request->kode_bank;
        $affiliate_user->kcp = $request->kcp;
        $affiliate_user->save();
