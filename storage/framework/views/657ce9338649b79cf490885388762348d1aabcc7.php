    ...
    <div class="p-md-3 p-2 text-left">
        ...
        <div class="fs-15">
            <?php if(home_base_price($product) != home_discounted_base_price($product)): ?>
                <del class="fw-600 opacity-50 mr-1"><?php echo e(home_base_price($product)); ?></del><br>
            <?php endif; ?>
            <span class="fw-700 text-primary"><?php echo e(home_discounted_base_price($product)); ?></span>
        </div>
        <div class="rating rating-sm mt-1">
            <?php echo e(renderStarRating($product->rating)); ?> <?php echo e($product->reviews()->count()); ?> Ulasan
        </div>
        ...
        <button onclick="buyNow()" class="btn btn-block text-center btn-primary">
                <i class="las la-shopping-cart"></i> Beli</button>
        
        </div>
    </div>
</div>
<?php /**PATH /home/n1487960/public_html/elesindoshop.com/resources/views/frontend/partials/product_box_1.blade.php ENDPATH**/ ?>