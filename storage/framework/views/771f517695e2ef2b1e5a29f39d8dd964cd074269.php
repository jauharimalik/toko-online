<div class="aiz-user-sidenav-wrap position-sticky z-1 shadow-sm">
    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
        ...
        <div class="sidemnenu mb-3">
            <ul class="aiz-side-nav-list px-2" data-toggle="aiz-side-menu">
                ...
                <?php else: ?>
                    ...
                    <?php if(addon_is_activated('affiliate_system') &&
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="javascript:void(0);"
                                class="aiz-side-nav-link <?php echo e(areActiveRoutes(['affiliate.user.index', 'affiliate.payment_settings'])); ?>">
                                <i class="las la-dollar-sign aiz-side-nav-icon"></i>
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="<?php echo e(route('support_ticket.index')); ?>"
                            class="aiz-side-nav-link <?php echo e(areActiveRoutes(['support_ticket.index'])); ?>">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" onclick="account_delete_confirm_modal('<?php echo e(route('account_delete')); ?>')" class="aiz-side-nav-link">
                        <i class="las la-user aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text"><?php echo e(translate('Delete My Account')); ?></span>
                    </a>
                </li>
...
<?php /**PATH C:\laragon\www\toko1\resources\views/frontend/inc/user_side_nav.blade.php ENDPATH**/ ?>