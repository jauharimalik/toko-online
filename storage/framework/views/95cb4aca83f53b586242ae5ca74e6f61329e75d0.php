        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-3 pb-5 px-xl-5">
                ...
                <div class="row bg-soft-warning py-3 ml-0 mr-0 border-left border-width-2 border-danger">
                    ...
                    <div class="col">
                        <p class="fw-600 mb-0"><?php echo e(translate('After deleting your account, wallet balance no longer in our system')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a id="account_delete_link" class="btn btn-danger btn-rounded btn-ok"><?php echo e(translate('Delete Account')); ?></a>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/n1487960/public_html/elesindoshop.com/resources/views/frontend/partials/account_delete_modal.blade.php ENDPATH**/ ?>