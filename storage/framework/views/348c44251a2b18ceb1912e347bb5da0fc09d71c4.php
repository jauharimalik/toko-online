...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-4">
        <div class="container">
            <div class="row gutters-10 bannerslide">
        ...
        <div class="container">
            <div class="row gutters-10">
                <?php if(get_setting('top10_categories') != null): ?>
                    <div class="<?php echo e($col_section); ?>">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                        ...
                        <div class="row gutters-5">
                            ...
                            <?php $__currentLoopData = $top10_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($category != null): ?>
                                    <div class="<?php echo e($col_block); ?>">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/n1487960/public_html/elesindoshop.com/resources/views/frontend/index.blade.php ENDPATH**/ ?>